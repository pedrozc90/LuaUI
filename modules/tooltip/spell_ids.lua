...
----------------------------------------------------------------
local UnitBuff, UnitDebuff, UnitAura, UnitGUID, GetGlyphSocketInfo = UnitBuff, UnitDebuff, UnitAura, UnitGUID, GetGlyphSocketInfo
...
local isClassicWoW = T.TocVersion < 200000
